copy (select a.userid, CASE WHEN a.gender = 'm' THEN '1' WHEN a.gender = 'f' THEN '0' ELSE 'NA' END gender ,
 ...
 where a.session_start < '03/31/2009' and
       ...
       COALESCE(a.country, 'NA') = COALESCE(b.countryname, 'NA') 
order by a.userid, a.session_start) to 'C:\Users\jayashree.raman\Documents\Learning\MIDS\capstone\lastfm-dataset-1K\usersessions-with-id-avg-train.csv' DELIMITER '|' CSV HEADER;
