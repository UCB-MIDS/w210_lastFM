...
mdl_between <-plm(session_length~age+session_length_mvavg+previous_duration+is_holiday+absence_time,  data = panel.data.train, model = "between")
...
## Prediction
predval <- prediction(mdl_between, data=test_data)
